...
use EApp\Component\{
	Driver\Tools\ModuleFake, ModuleConfig, Scheme\ModuleSchemeDesigner
};
use EApp\Database\Connection;
use EApp\Event\EventManager;
use EApp\Prop;
use EApp\Support\{
	Exceptions\NotFoundException, Interfaces\Loggable, Str, Traits\GetModuleComponent, Traits\LoggableTrait
};
use EApp\System\{
	Fs\FileResource, Interfaces\SystemDriver
};
use EApp\Text;

class ModuleRegisterDriver implements SystemDriver, Loggable
{
	...
	private function getManifest(): FileResource
	{
	...
	private function getModuleName( FileResource $manifest ): string
	{
		// check module name
