...
use EApp\DB\Query\Processors\Processor;
use EApp\Support\Arr;
use EApp\DB\Query\Builder as QueryBuilder;
use EApp\DB\Query\Grammars\Grammar as QueryGrammar;
...
class Connection implements ConnectionInterface
{
	 ...
	 *
	 * @var \EApp\DB\Query\Grammars\Grammar
	 */
	 ...
	 *
	 * @var \EApp\DB\Query\Processors\Processor
	 */
	 ...
	 *
	 * @return \EApp\DB\Query\Grammars\Grammar
	 */
	 ...
	 *
	 * @return \EApp\DB\Query\Processors\Processor
	 */
	...
	public function logQuery( $query, $bindings, $time = null )
	{
		...
		if( isset( $this->events ) )
		{
			$this->events->dispatch( new Events\QueryExecutedEvent( $query, $bindings, $time, $this ) );
		}
	 ...
	 *
	 * @param  \EApp\DB\QueryException $e
	 * @param  string $query
	 * @param  array $bindings
	 * @param  \Closure $callback
	 * @return mixed
	 ...
	 *
	 * @param  mixed $value
	 * @return \EApp\DB\Query\Expression
	 */
	 ...
	 *
	 * @param  \EApp\DB\Query\Grammars\Grammar $grammar
	 * @return void
	 */
	 ...
	 *
	 * @param  \EApp\DB\Query\Processors\Processor $processor
	 * @return void
	 */
	 ...
	 *
	 * @param  \EApp\DB\Grammar $grammar
	 * @return \EApp\DB\Grammar
	 */
