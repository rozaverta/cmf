...
class MySqlGrammar extends Grammar
{
	 ...
	 *
	 * @param  \EApp\DB\Query\Builder  $query
	 * @return string
	 */
	 ...
	 *
	 * @param  string  $key
	 * @param  \EApp\DB\Query\JsonExpression  $value
	 * @return string
	 */
	...
	protected function wrapJsonSelector($value)
	{
		...
		return sprintf('%s->\'$.%s\'', $field, (new Collection($path))->map(function ($part) {
			return '"'.$part.'"';
		})->implode('.'));
	}
